			...
			if(styles != null) {
				if(styles.backgroundColor != undefined) {
					_styles.background = {
						...
						alpha: (styles.backgroundAlpha != undefined) ? styles.backgroundAlpha : 1
					};
				}
				if(styles.borderColor != undefined) {
					_styles.border = {
						top: { color: styles.borderColor, alpha: 1 },
						right: { color: styles.borderColor, alpha: 1 },
						bottom: { color: styles.borderColor, alpha: 1 },
						left: { color: styles.borderColor, alpha: 1 }
					};
